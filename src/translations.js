...
export const translations = {
  ...
  de: {
    ...
    usernameAvailable: 'âœ“ Verfügbar',
  ...
  pl: {
    ...
    // News Section
    newsTitle: '📰 Najnowsze wiadomoÅ›ci',
    newsUpdating: 'Aktualizowanie...',
    newsLive: 'Na Å¼ywo • Auto-aktualizacja',
    ...
    dummyNews1Summary: 'FIFA reaguje na krytykÄ™ wysokich cen biletów.',
    dummyNews2Title: 'Grupa Niemiec: Potencjalni rywale',
    dummyNews2Summary: 'Losowanie grup MÅš wkrótce.',
    ...
    triviaWorldChampion: 'Mistrz Åšwiata! 🥇',
    triviaVeryGood: 'Bardzo dobrze! 🥈',
    triviaWellPlayed: 'Dobrze zagrane! 🥉',
    triviaKeepPracticing: 'Ä†wicz dalej! 💪',
    
    // Sentiment Features
    sentimentFanMood: 'Nastrój kibiców',
    sentimentSocialPulse: 'Puls mediów spoÅ‚ecznoÅ›ciowych',
    ...
    posOut: 'Odpada',
    groupLegend: '🏟¢ Miejsca 1-2 awansujÄ… • 🏟¡ Miejsce 3 moÅ¼e awansowaÄ‡ • 🔴 Odpada',
    ...
    votesSubmitted: 'gÅ‚osów oddanych',
    noVotesYet: 'Brak gÅ‚osów',
    ...
    globalRankingDesc: 'Wszyscy zarejestrowani gracze w bezpoÅ›rednim porównaniu. Typuj trafnie i wspinaj siÄ™ w górÄ™!',
    ...
    createOrJoin: 'Utwórz nowy ranking lub doÅ‚Ä…cz do istniejÄ…cego!',
    myRankings: 'Moje rankingi',
    viewRanking: 'Zobacz ranking',
    backToMyRankings: 'WróÄ‡ do moich rankingów',
    invite: 'ZaproÅ›',
    loadingMembers: 'Åadowanie czÅ‚onków...',
    noMembersYet: 'Brak czÅ‚onków',
    ...
    pollSubtitle: 'Wybierz swojego faworyta spoÅ›ród 48 druÅ¼yn!',
    voteLater: 'ZagÅ‚osuj póÅºniej',
    pollResultsTitle: 'Aktualne wyniki gÅ‚osowania',
    pollTotalVotes: 'gÅ‚osów Å‚Ä…cznie',
    pollYourVote: 'Twój gÅ‚os',
    pollContinueToTrivia: 'PrzejdÅº do quizu',
    pollNoVotesYet: 'Brak gÅ‚osów',
    yourVote: 'Twój gÅ‚os',
    alreadyVoted: 'JuÅ¼ zagÅ‚osowaÅ‚eÅ›',
    totalVotes: 'GÅ‚osów Å‚Ä…cznie',
    ...
    worldChampions: 'Mistrzów Åšwiata',

    // Trivia Section
    triviaTitle: '🧠  Quiz o Mistrzostwach Åšwiata',
    question: 'Pytanie',
    score: 'Punkty',
    correct: 'âœ“ Dobrze! +10 punktów',
    wrong: 'âœ— Å¹le!',
    ...
    noExplanation: 'Brak wyjaÅ›nienia.',
    triviaEnglishNotice: 'Angielskie tÅ‚umaczenia sÄ… dodawane. Niektóre pytania mogÄ… byÄ‡ jeszcze po niemiecku.',
    triviaPolishNotice: 'Polskie tÅ‚umaczenia sÄ… dodawane. Niektóre pytania mogÄ… byÄ‡ jeszcze po niemiecku lub angielsku.',
    
    // Trivia Results
    triviaResultChampion: 'Mistrz Åšwiata! 🥇',
    triviaResultGreat: 'Åšwietnie! 🥈',
    triviaResultGood: 'Dobrze zagrane! 🥉',
    triviaResultPractice: 'Ä†wicz dalej! 💪',
    ...
    // Guide Section
    guideTitle: '📺 Przewodnik kibica MÅš 2026',
    guideLockedTitle: 'Przewodnik wkrótce',
    guideLockedDescription: 'Kompletny przewodnik kibica na MÅš 2026 z poradami podróÅ¼niczymi, informacjami o stadionach i nie tylko zostanie wkrótce udostÄ™pniony.',

    // Sentiment Section
    sentimentTitle: 'Tygodniowy barometr nastrojów',
    sentimentComingSoon: 'Wkrótce!',
    sentimentDescription: 'Wkrótce zobaczysz cotygodniowe analizy nastrojów wokóÅ‚ wszystkich reprezentacji na podstawie mediów spoÅ‚ecznoÅ›ciowych, wiadomoÅ›ci i ankiet kibiców.',
    sentimentFeature1: 'Barometr nastrojów kibiców',
    sentimentFeature2: 'Puls mediów spoÅ‚ecznoÅ›ciowych',
    sentimentFeature3: 'Wsparcie dla druÅ¼yn na Å›wiecie',
    sentimentFeature4: 'Analiza tygodniowa',
    
    // Sentiment Barometer
    wcMood: 'Nastrój MÅš',
    articlesAnalyzed: 'artykuÅ‚ów przeanalizowanych',
    ...
    registerSuccess: 'Rejestracja zakoÅ„czona! PotwierdÅº swój adres e-mail.',
    ...
    backToLogin: 'WróÄ‡ do logowania',
    loginWithCode: 'Zaloguj kodem e-mail (bez hasÅ‚a)',
    loginWithPassword: 'Zaloguj hasÅ‚em',
    resetLinkSent: 'Link resetujÄ…cy wysÅ‚any na twój e-mail!',
    codeSent: 'Kod wysÅ‚any na twój e-mail!',
    ...
    secureConnection: '🔒 Bezpieczne poÅ‚Ä…czenie',
    ...
    errorPasswordShort: 'HasÅ‚o musi mieÄ‡ co najmniej 6 znaków.',
    errorPasswordMatch: 'HasÅ‚a nie sÄ… zgodne.',
    errorInvalidCode: 'NieprawidÅ‚owy kod. Spróbuj ponownie.',
    errorGeneric: 'WystÄ…piÅ‚ bÅ‚Ä…d. Spróbuj ponownie.',
    ...
    errorPasswordWeak: 'HasÅ‚o za sÅ‚abe. Min. 12 znaków z 1 wielkÄ…, 1 maÅ‚Ä… literÄ…, 1 cyfrÄ… i 1 znakiem specjalnym.',
    ...
    footerTeams: '48 druÅ¼yn • 104 mecze',
    ...
    // ==================== FAN GUIDE ====================
    guideHeaderTitle: '📺 PRZEWODNIK KIBICA MÅš 2026',
    guideHeaderSubtitle: 'Streaming • Bilety • PodróÅ¼e • GadÅ¼ety',
    guideHeaderInfo: 'Wszystko co kibice muszÄ… wiedzieÄ‡',
    guideStreaming: '📺 Streaming',
    guideTickets: '🎫 Bilety',
    guideTravel: 'âœˆï¸ PodróÅ¼e',
    guideMerchandise: '👕 GadÅ¼ety',
    guideGermany: 'Niemcy',
    guideAustria: 'Austria',
    ...
    guideTicketTip3: 'Nie kupuj od poÅ›redników',
    guideOfficialPortal: 'Oficjalny portal biletowy FIFA',
    guideTravelTitle: 'âœˆï¸ Porady podróÅ¼ne',
    guideVisa: 'Wiza',
    ...
    guideMerchTitle: '👕 GadÅ¼ety kibica',
...
export const teamTranslations = {
  ...
  pl: {
    'Mexiko': 'Meksyk', 'Südafrika': 'RPA', 'Südkorea': 'Korea PÅ‚d.',
    ...
    'Elfenbeinküste': 'WybrzeÅ¼e KoÅ›ci SÅ‚oniowej', 'Niederlande': 'Holandia', 
